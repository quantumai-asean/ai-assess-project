...
[ ] make a streamlit UI that configures a modelcard; supportive components: [streamlit-pydantic](https://github.com/lukasmasuch/streamlit-pydantic#examples), at the moment streamlit-pydantic depends on pydantic v1 (pip install "pydantic==1.*")
